<?php 
require_once ("../../controller/auditoria/get_login.php");
...
<head>
	<meta charset="UTF-8">
	<title>lista de usuarios logueados</title>
...
<body>
	...
	<section id="container">
		<h1><i class="fas fa-users"></i> Lista de usuarios logueados</h1>
		...
		<table>
			...
			if($query > 0){
			 ...
			 ?>
			<tr>
				<td><?php echo $data["id_sesion"] ;?></td>
				<td><?php echo $data["usuario"]; ?></td>
				<td><?php echo $data["id_user_login"] ;?></td>
				<td><?php echo $data["hora_user_login"] ;?></td>
				<td><?php echo $data["fecha_user_login"] ;?></td>
			</tr>
			<?php 
