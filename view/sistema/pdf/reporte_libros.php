...
function Header()
{
	...
	$this->Ln(10);
    // Título
    $this->Cell(200,10,'Reporte de libros',0,0,'C');
    // Salto de línea
  
    $this->Ln(15);
    $this->cell(20, 5, 'Cota', 1, 0, 'C',0);
    $this->cell(25, 5, 'Nombre de libro', 1, 0, 'C',0);
    $this->cell(20, 5, 'Autor', 1, 0, 'C',0);
    $this->cell(30, 5, utf8_decode('Año de libro'), 1, 0, 'C',0);
    $this->cell(20, 5, utf8_decode('Nº Ejemplar'), 1, 0, 'C',0);
...
while($row = $resultado->fetch_assoc()){
 ...
 $pdf->cell(20, 5, $row['autor'], 1, 0, 'C',0);
